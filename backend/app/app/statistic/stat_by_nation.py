...
class PDF(FPDF):
    ...
    def create_statistic_by_nation(data:Any,all_etudiant, schemas:str):
        titre_stat = [{"name":'',"value":["Niveau"]},{"name":"Africaine","value":["M","F"]},{"name":"Asiatique","value":["M","F"]},
                      {"name":"Comorienne","value":["M","F"]},{"name":"Européene","value":["M","F"]},{"name":"Autre à préciser","value":["M","F"]}]
