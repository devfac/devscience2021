...
def update_etudiant(
    *,
    ...
    if etudiant_:
        etudiant = crud.ancien_etudiant.update_etudiant(schema=schema,num_carte=etudiant_create["num_carte"], obj_in=etudiant_create)
    else:
...
def delete_etudiant_nouveau(
    *,
    ...
    etudiant = crud.nouveau_etudiant.delete_etudiant(schema=schema, num_carte=num_carte)
    return etudiant
