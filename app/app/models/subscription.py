...
class Subscription(Base):
    ...
    student = relationship("Student", back_populates="subscription", foreign_keys=[num_carte])
    year = relationship("CollegeYear", back_populates="subscription", foreign_keys=[id_year])
